...
class Room extends $pb.GeneratedMessage {
  ...
  factory Room({
    ...
    $core.String? name,
    $4.Timestamp? createdAt,
    $core.bool? dialogRoom,
    $4.Timestamp? lastMessageTime,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
  ...
  @$pb.TagNumber(4)
  $core.bool get dialogRoom => $_getBF(3);
  @$pb.TagNumber(4)
  set dialogRoom($core.bool v) {
    $_setBool(3, v);
  }

  @$pb.TagNumber(4)
  $core.bool hasDialogRoom() => $_has(3);
  @$pb.TagNumber(4)
  void clearDialogRoom() => clearField(4);

  @$pb.TagNumber(5)
  $4.Timestamp get lastMessageTime => $_getN(4);
  @$pb.TagNumber(5)
  set lastMessageTime($4.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  void clearLastMessageTime() => clearField(5);
  @$pb.TagNumber(5)
  $4.Timestamp ensureLastMessageTime() => $_ensure(4);
}
