...
final $typed_data.Uint8List createRoomRequestDescriptor = $convert.base64Decode(
    'ChFDcmVhdGVSb29tUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEhkKCHVzZXJfaWRzGAIgAygJUgd1c2VySWRz');
...
final $typed_data.Uint8List listRoomsRequestDescriptor = $convert.base64Decode(
    'ChBMaXN0Um9vbXNSZXF1ZXN0EjsKCnBhZ2VfdG9rZW4YASABKAsyHC5nb29nbGUucHJvdG9idWYuU3RyaW5nVmFsdWVSCXBhZ2VUb2tlbhIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXpl');
...
final $typed_data.Uint8List messageRequestDescriptor = $convert.base64Decode(
    'Cg5NZXNzYWdlUmVxdWVzdBIYCgdtZXNzYWdlGAEgASgJUgdtZXNzYWdlEhkKB3VzZXJfaWQYAiABKAlIAFIGdXNlcklkEhkKB3Jvb21faWQYAyABKAlIAFIGcm9vbUlkQgsKCXJlY2lwaWVudA==');
...
final $typed_data.Uint8List messageResponseDescriptor = $convert.base64Decode(
    'Cg9NZXNzYWdlUmVzcG9uc2USFwoHcm9vbV9pZBgBIAEoCVIGcm9vbUlkEigKB21lc3NhZ2UYAiABKAsyDi5tb2RlbC5NZXNzYWdlUgdtZXNzYWdl');
...
final $typed_data.Uint8List listRoomsResponseDescriptor = $convert.base64Decode(
    'ChFMaXN0Um9vbXNSZXNwb25zZRI7CgpuZXh0X3Rva2VuGAEgASgLMhwuZ29vZ2xlLnByb3RvYnVmLlN0cmluZ1ZhbHVlUgluZXh0VG9rZW4SIQoFcm9vbXMYAiADKAsyCy5tb2RlbC5Sb29tUgVyb29tcw==');
...
final $typed_data.Uint8List createRoomStatusDescriptor = $convert.base64Decode(
    'ChBDcmVhdGVSb29tU3RhdHVzEhcKB3Jvb21faWQYASABKAlSBnJvb21JZBISCgRuYW1lGAIgASgJUgRuYW1lEhQKBXVzZXJzGAMgAygJUgV1c2Vycw==');
